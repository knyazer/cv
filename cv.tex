...
simulation, reinforcement learning, and control. Developed methods improving stability in
BPTT, contributed to AutoML and meta-learning projects under Prof. Tom Viering, and
co-authored papers under submission. Also maintain open-source contributions to JAX-based ML libraries.
