...
\noindent
\textbf{International A Levels} \hfill 01/09/2020 - 01/12/2022\\
\vspace{-4.5mm}
\begin{itemize}[noitemsep]
    \item Pure Mathematics: A*
...
\begin{itemize}[noitemsep]
    ...
    \item \textbf{Project management:} Agile, Scrum, Waterfall
    ...
    \item \textbf{Other Tools:} git, flake8, ruff, containerd, JIRA, GitHub
\end{itemize}
